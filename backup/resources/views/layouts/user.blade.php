...
<body>
    ...
    <div style="padding-left:20%;padding-right:20%;margin-top:15px;">
        <nav class="navbar navbar-expand-md navbar-light">
            <div class="container">
                <a id="a1"
                    style="border-top-left-radius:20px;border-bottom-left-radius:20px;border-bottom-right-radius:20px"
                    class="btns" href="{{ route('companies.member') }}">{{ __('ข้อมูลครุภัณฑ์') }}</button></a>
                <!-- <a class="btns" style="border-top-right-radius:20px;border-bottom-right-radius:20px"
                    href="{{ route('bring.member') }}" id="a1">{{ __('การเบิกครุภัณฑ์') }}</a>
    -->
            </div>
