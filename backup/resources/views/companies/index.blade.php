                ...
                <form action="{{ route('web.find') }}" method="GET">
                    ...
                    <div class="input-group" style="margin-bottom:10px;">
                        ...
                        <button type="submit" class="btn btn-outline-primary"
                            style="margin-left: 1.5px;margin-top:10px;margin-right: 1.5px; border-radius :10px;"
                        ...
                        <tbody>
                            @foreach ($companies as $company)
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <a href="{{ route('detailCompany', $company->id) }}"
                                            class="text-primary">รายละเอียด</a>
                                    </td>
                                    <td>{{ $company->unit }}</td>
                                    <td>{{ $company->place }}</td>

                                    <?php $doubleValue = $company->per_price;
                                    ...
                                    <td>
                                        ...
                                        <div class="delete-row">
                                            ...
                                            <button class="delete-btn"
                                                data-target="#delete-alert-{{ $company->id }}">ลบ</button>
                                            <form action="{{ route('companies.destroy', $company->id) }}" method="POST"
                                                ...
                                                <div class="delete-alert hidden" id="delete-alert-{{ $company->id }}">
                                                    <img src="data:image/png;base64,"
                                                        alt="alert" width="100px" height="100px"
