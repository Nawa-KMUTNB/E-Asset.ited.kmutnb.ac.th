            ...
            <div class="row">
                ...
                <form action="{{ route('web.find') }}" method="GET">
                    ...
                    <div class="input-group" style="margin-bottom:10px;">
                        ...
                        <div class="mt-2 mb-2 d-grid  d-md-flex justify-content-md-end ">
                            <a href="{{ route('money.create') }}" class="btn btn-primary"
                                style="margin-right:1.0px">เพิ่มครุภัณฑ์</a>
                        ...
                        <input type="text" class="form-control" name="query" placeholder="ค้นหาครุภัณฑ์"
                            value="{{ request()->input('query') }}" id="search">
                        <button type="submit" class="btn btn-outline-primary" id="height">ค้นหา</button>
                        <a href="{{ route('companies.index') }}" class="btn btn-outline-danger" id="height">ล้างการค้นหา
                        </a>
                    </div>
                </form>
            </div>
                ...
                <table class="table table-hover table-bordered " style="background-color: #fff ;">
                    ...
                    @foreach ($companies as $company)
                        <tr style="text-align: center">
                            ...
                            <td>{{ date('d-m-Y', strtotime($company->date_into)) }}</td>
                            <td>{{ $company->name_asset }}</td>
                            {{-- <td>{{ $company->detail }}</td> --}}
                            <td>
                                <a href="{{ route('detailCompany', $company->id) }}" class="text-primary">รายละเอียด</a>
                            </td>
                            <td>{{ $company->unit }}</td>
                            <td>{{ $company->place }}</td>
                                ...
                                <div class="delete-row">
                                    ...
                                    <form action="{{ route('companies.destroy', $company->id) }}" method="POST"
                                        ...
                                        <div class="delete-alert hidden" id="delete-alert-{{ $company->id }}">
                                            ...
                                            alt="alert"
                                                width="100px" height="100px" style="margin-left:20px">
                                            <p class="p-d">คุณต้องการจะลบข้อมูลครุภัณฑ์ใช่หรือไม่?</p>
